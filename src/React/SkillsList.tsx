...
const SkillsList = () => {
  ...
  const skills = {
    "Desarrollo Web": [
      "🔧 Landing pages responsivas y optimizadas",
      "⚡ Aplicaciones web dinámicas modernas ",
      "📅 Integración de Wordpress como CMS",
      "🎨 Mejora de interfaces con HTML y CSS"
    ],
    "Diseño UI/UX y Prototipado": [
      "🎨 Interfaces funcionales enfocadas en el usuario",
      "🧩 Prototipos y diseño en Figma",
      "📱 Adaptación visual a todo tipo de dispositivos",
